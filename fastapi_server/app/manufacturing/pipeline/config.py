...
Phase 2のX-R管理図およびPhase 3のAI異常検知で使用する設定を一元管理します。
"""

# データファイル設定
CONTROL_LIMIT_CALCULATION_FILE = "学習データ_202509-202603.csv"  # 管理限界計算用データ
...
# Columns retained in TOP25 output for live anomaly deployment passthrough.
PHASE3_PASSTHROUGH_COLUMNS = ("生産日", "吐出パターン番号")
...
# Phase 3: 特徴量エンジニアリングモード
# 'full': 全特徴量を生成（従来の方法）
# 'top25': DataRobotで重要度が高い上位25特徴量のみ生成
PHASE3_FEATURE_MODE = "top25"  # デフォルトはtop25モード

# Phase 3: DataRobotモデルで重要度が高い上位25特徴量
# (Feature Importanceに基づく - 画像解析結果より)
TOP_25_IMPORTANT_FEATURES = [
    "preheat_duration_injection_duration_ratio",
    "余熱時間_scaled",
    "preheat_duration",
    "preheat_duration_injection_duration_ratio_scaled",
    "preheat_duration_scaled",
    "preheat_duration_curing_duration_ratio",
    "余熱時間",
    "preheat_duration_curing_duration_ratio_scaled",
    "preheat_duration_negative",
    "生産吐出時間(sec)_scaled",
    "硬化時間",
    "取出終了日時_dayofweek",
    "A剤タンク2圧力(Mpa)_scaled",
    "余熱開始日時",
    "投入開始日時_dayofweek",
    "生産日_dayofweek",
    "Y座標",
    "生産日_day_scaled",
    "生産日",
    "生産日_dayofweek_scaled",
    "anomaly_flag_ratio",
    "time_anomaly_score",
    "curing_duration_ratio",
    "B剤流圧(Mpa)_scaled",
    "注入時間",
]

# Phase 3: TOP25モードで必要な元特徴量の定義
# TOP25に含まれる特徴量を生成するために必要な中間特徴量
TOP_25_REQUIRED_BASE_FEATURES = {
    # 時間特徴量の成分
    "取出終了日時_dayofweek",
    "投入開始日時_dayofweek",
    "生産日_dayofweek",
